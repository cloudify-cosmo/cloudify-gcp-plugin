...
with open(os.path.join(os.path.dirname(__file__), '../plugin.yaml')) as f:
    plugin_data = yaml.load(f)

# The full version, including alpha/beta/rc tags.
release = next(iter(plugin_data['plugins'].values()))['package_version']
...
latex_documents = [
    (master_doc,
     'cloudify-gcp-plugin.tex',
     u'cloudify-gcp-plugin Documentation',
     u'GigaSpaces Technologies Ltd.',
     'manual'),
]
